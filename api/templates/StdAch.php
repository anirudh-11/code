...
session_start();
 ...
 else
 {
    if(isset($_POST['sub']))
    {
      $val=$_POST['achieves'];
      $e=$_SESSION['ID'];
  $sql="INSERT INTO achievements(sid,achieve,validation) VALUES('".$e."','".$val."',1)";
  if($sql)
    header("Location:Login.php");
  $qry=mysqli_query($connect,$sql);

  header('refresh:5;Location:Studentportal.php');
  header('Location:Std-Acheivements-Success-Validation.html');
...
<body class="htmlNoPages">
  ...
  <p class="gwd-p-bifg"><span class="gwd-span-1psi">Acheivements:</span><br>
    ...
    <form method='POST'>
  <input type='Submit' id="button_1" class="gwd-button-i7qd" name='sub'>Submit<br>
  <input type="text" id="text_1" class="gwd-input-1h05" name='achieves'>
  <input type='Submit' id="button_2" class="gwd-button-1jw7 text-tool-feedback" name='sub1'>Logout</br>
