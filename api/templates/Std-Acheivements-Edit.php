<?php 
session_start();
 $connect =mysqli_connect("localhost","root","","dbms project");
 if(!$connect)
 {
 ...
 else
 {
    ...
    {
      $val=$_POST['achieves'];
  $sql="INSERT INTO achievements(sid,achieve,validation) VALUES('".$SESSION['ID']."','".$val."',1)";
...
<body class="htmlNoPages">
  ...
  <p class="gwd-p-bifg"><span class="gwd-span-1psi">Acheivements:</span><br>
    ...
    <form method='POST'>
  <input type='Submit' id="button_1" class="gwd-button-i7qd" name='sub' value = "Submit">Submit</br>
  <input type="text" id="text_1" class="gwd-input-1h05" name='achieves'>
  <input type='Submit' id="button_2" class="gwd-button-1jw7 text-tool-feedback" name='sub1' value = "Logout">Logout</button>
