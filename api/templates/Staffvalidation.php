...
<head>
  <meta charset="utf-8">
  <title>Staff validation page</title>
...
<body class="htmlNoPages">
  ...
  <!-- <p class="gwd-p-f3o9 gwd-p-ty1l gwd-p-bqs7" id="ele_2" data-gwd-tl-locked=""><a href="www.google.com">Student Personal life</a> -->
  <!-- </p> -->
  <p class="gwd-p-f3o9 gwd-p-ty1l gwd-p-1jpe gwd-p-1lix" id="ele_1" data-gwd-tl-locked=""><a href="StafeditVali.php">Student Achievements</a>
  </p>
<!--   <p class="gwd-p-f3o9 gwd-p-ty1l gwd-p-1jpe gwd-p-grue" id="ele_3" data-gwd-tl-locked=""><a href="faculty_cou_view.php">Faculty Personal life</a>
  </p>
 -->  </span><br>
    
  </p>
  <form method="POST">
  <input type='Submit' id="button_1" class="gwd-button-1jw7" data-gwd-tl-locked="" name='sub' value='Logout'>Logout</br>
  <p class="gwd-p-1hjf" id="1" data-gwd-tl-locked=""><?php echo $_SESSION['ID'];?></p>
</form>
</body>
